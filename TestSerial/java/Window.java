...
class Window {
	...
	JButton exitButton = makeButton("Exit", new ActionListener(){
		public void actionPerformed(ActionEvent e) {
			...
			for (int i = 1; i<3; i++){
				parent.lossratio[i] = (float)parent.lostnumber[i]/(parent.lastseq[i] - parent.firstseq[i] + 1);
				System.out.println("total loss ratio @ node " + i + " : " + parent.lossratio[i]);
			}		
			System.exit(1);
		}
	});
